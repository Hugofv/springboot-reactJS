...
import com.star.wars.rest.util.*;
 ...
 *
 */
public abstract class StarwarsRestResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Método handle referente a exceção {@link com.star.wars.rest.util.BusinessException}.
     *
     * @param e
     * @param request
     * @return
    ...
    public ResponseEntity<Object> handleBusinessException(final BusinessException e) {
        ...
        if (e.getCode() != null) {
            ...
            if (e.hasParameters()) {
                ...
                if (e.isConcat()) {
                    String paramsConcat = Util.getValorConcatenador(", ", params);
    ...
    protected ResponseEntity<Object> handleBindException(final BindException ex, final HttpHeaders headers,
        ...
        response.setStatus(HttpStatus.BAD_REQUEST.value());
        response.setError(HttpStatus.BAD_REQUEST.getReasonPhrase());
        response.addAttribute(new FieldResponse(ex.getFieldError().getField(), ex.getFieldError().getDefaultMessage()));
        return ResponseEntity.status(HttpStatus.BAD_REQUEST.value()).body(response);
    }
